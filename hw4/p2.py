...
if __name__=='__main__':
    ...
    if use_cuda == True:
        model = torch.load('p2_model/M')
        G = torch.load('p2_model/G')
    else:
        model = torch.load('p2_model/M', map_location=torch.device('cpu'))
        G = torch.load('p2_model/G', map_location=torch.device('cpu'))
